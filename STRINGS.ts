...
const en = {
  ...
  SERVICE_DETAIL_SELECTED_PRICING: '선택된 요금제',
  SERVICE_DETAIL_UNSELECTED_PRICING: '선택 안된 요금제',
  SERVICE_DETAIL_ADDITIONAL_PRICING: `추가 요금제(+3,800)원`,
  SERVICE_DETAIL_SECTION_PAYMENT: '결제정보',
  SERVICE_DETAIL_PAYMENT_PROMOTION: '프로모션',
  SERVICE_DETAIL_PAYMENT_FIRST_DATE: '최초 결제일',
  SERVICE_DETAIL_PAYMENT_DUE_DATE: '결제 만기일',
  SERVICE_DETAIL_PAYMENT_ALRAM_BEFORE: '결제 전 알림',
  SERVICE_DETAIL_SERVICE_RATE: '서비스 만족도',
  SERVICE_DETAIL_REGISTER: '등록하기',
  SIGN_OUT: 'Sign Out',
};
